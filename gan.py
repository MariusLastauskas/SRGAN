...
#     mini_train_images.append(image_minify(image))
#     print(i)
#     i = i + 1

# save_list(mini_train_images, mini_train_images_file)
print('####################### Loading minified images')
l = load_list(mini_train_images_file)
...
# generate untrained image
# test = np.array(image_minify(train_images[0])).reshape([1, 14*14])
...
def train_step(images):
    ...
    # print('images.shape')
    # print(images.shape)
    # minified = image_batch_minify(images)
    # print('minified.shape')
    # print(minified.shape)

    with tf.GradientTape() as gen_tape, tf.GradientTape() as disc_tape:
        # np.array(image_minify(train_images[0])).reshape([1, 14*14])
